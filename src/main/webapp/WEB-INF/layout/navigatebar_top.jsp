...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<c:if test="${SPRING_SECURITY_CONTEXT eq null }">
		...
		<ul class="nav navbar-right top-nav">
			<c:url var="loginUrl" value="/access/login" />
			<li class="dropdown">
			<a href="${loginUrl}" class="dropdown-toggle"> 
	...
	<c:if test="${SPRING_SECURITY_CONTEXT ne null }">
		...
		<ul class="nav navbar-right top-nav">
				...
				<ul class="dropdown-menu message-dropdown">
					...
					<li class="message-preview"><a href="#">
							<div class="media">
								...
								<div class="media-body">
									<h5 class="media-heading">
										<strong><sec:authentication property="principal.firstName"/>
			...
			<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
					class="fa fa-user"></i> Welcome <sec:authentication property="principal.firstName"/> 
											&nbsp;<sec:authentication property="principal.lastName"/>
											<b class="caret"></b></a>
